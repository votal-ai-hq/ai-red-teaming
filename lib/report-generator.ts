...
const SEVERITY_WEIGHTS: Record<AttackCategory, number> = {
  ...
  mcp_resource_poisoning: 15,
  mcp_tool_annotation_spoofing: 14,
  mcp_protocol_downgrade: 13,
  mcp_session_hijacking: 15,
  mcp_capability_manipulation: 14,
